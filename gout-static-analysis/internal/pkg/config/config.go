...
import (
	...
	"xyz.asd.qwe/gout-static-analysis/internal/pkg/config/regexp"
)
...
type Config struct {
	...
	NewSourceTags				[]NewSourcesMatcher
}
...
func (ft *fieldTagMatcher) UnmarshalJSON(bytes []byte) error {
	validFieldTagMatcherFields := []string{"key", "value", "func"}
